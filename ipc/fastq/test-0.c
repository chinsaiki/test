...
int main()
{
    ...
    FastQCreateModule(NODE_1, max_msg, sizeof(unsigned long));
    FastQCreateModule(NODE_2, max_msg, sizeof(unsigned long));
    FastQCreateModule(NODE_3, max_msg, sizeof(unsigned long));
    FastQCreateModule(NODE_4, max_msg, sizeof(unsigned long));
