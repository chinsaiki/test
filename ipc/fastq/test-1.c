...
int main()
{
    ...
    FastQCreateModuleStats(NODE_1, max_msg, sizeof(unsigned long));
    FastQCreateModuleStats(NODE_2, max_msg, sizeof(unsigned long));
    FastQCreateModuleStats(NODE_3, max_msg, sizeof(unsigned long));
    FastQCreateModuleStats(NODE_4, max_msg, sizeof(unsigned long));
